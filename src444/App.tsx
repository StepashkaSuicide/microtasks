...
function App() {
    ...
    const callBackNewTodo = (newTitle: string)=> {
        let todoId= v1()
        let newTodo: TodolistType = {id: todoId, title: newTitle, filter: "all"}
        setTodolists([newTodo, ...todolists, ])
        setTasks({...tasks, [newTodo.id]:[]})

    }
    const editSpanTitle = (todolistId: string, newTitle: string)=> {
    ...
    return (
        <div className="App">
            <Input callBack={callBackNewTodo}/>
            {
                todolists.map(tl => {
