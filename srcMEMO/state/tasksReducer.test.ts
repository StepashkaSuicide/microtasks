...
import {addTodolistAC} from './1todolists-reducer';
...
test('correct task should be added to correct array', () => {
    ...
    expect(endState['todolistId'][0].title).toBe('juce');
...
test('status of specified task should be changed', () => {
    ...
    expect(endState['todolistId'][1].isDone).toBe(false);
    expect(endState['todolistId'][1].isDone).toBe(true);
});
